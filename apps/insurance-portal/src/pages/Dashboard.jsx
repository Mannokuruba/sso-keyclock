...
// Mock data — replace with real API calls using useApiToken hook
const mockSummary = {
  activePolicies: 3,
  openClaims: 1,
  ...
  return (
    <div className="page-container">
      ...
      <div className="welcome-banner">
        ...
        <Link to="/claims" className="btn-primary sm">
          + File a Claim
        </Link>
      </div>
      ...
      <div className="summary-grid">
        <div className="summary-card blue">
          ...
          <div>
            <p className="summary-num">{mockSummary.activePolicies}</p>
        ...
        <div className="summary-card orange">
          <span className="summary-icon">🔍</span>
          <div>
            <p className="summary-num">{mockSummary.openClaims}</p>
            <p className="summary-label">Open Claims</p>
          </div>
        </div>
        <div className="summary-card green">
          <span className="summary-icon">💰</span>
          <div>
            <p className="summary-num">{mockSummary.nextPremium.amount}</p>
            <p className="summary-label">Next Premium ({mockSummary.nextPremium.date})</p>
          </div>
        </div>
        <div className="summary-card purple">
          <span className="summary-icon">🛡️</span>
          <div>
            <p className="summary-num">{mockSummary.totalCoverage}</p>
            <p className="summary-label">Total Coverage</p>
          </div>
        </div>
      </div>
