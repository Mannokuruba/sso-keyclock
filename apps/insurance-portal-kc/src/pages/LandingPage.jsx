...
export default function LandingPage() {
  ...
  useEffect(() => {
    if (keycloak.authenticated) navigate('/dashboard')
        ...
        <div className="hero-visual">
          <div className="hero-card">
            ...
            <div className="hc-body">
              ...
              <div className="hc-row hc-blurred"><span className="hc-label">Policy #</span><span className="hc-val">●●●●●●●●●●</span></div>
              <div className="hc-row hc-blurred"><span className="hc-label">Type</span><span className="hc-val">●●●●●●●●</span></div>
              <div className="hc-row hc-blurred"><span className="hc-label">Status</span><span className="hc-val">●●●●●</span></div>
              <div className="hc-row hc-blurred"><span className="hc-label">Premium</span><span className="hc-val">●●●●●●●</span></div>
              <div className="hc-row hc-blurred"><span className="hc-label">Coverage</span><span className="hc-val">●●●●●●●</span></div>
              <div className="hc-auth-bar">
                <span>🔐</span>
                <span className="hc-auth-text">Protected by Keycloak MFA</span>
              </div>
            </div>
          </div>
        </div>
